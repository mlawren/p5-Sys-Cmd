...
Note that C<close()> is automatically called when the C<Sys::Cmd>
object is destroyed. Annoyingly, this means that in the following
example C<$fh> will be closed when you tried to use it:
...
L<System::Command>, L<Proc::Spawn>, L<IPC::Run>, L<IPC::Run3>,
L<IPC::Cmd>, L<Spawn::Safe>
