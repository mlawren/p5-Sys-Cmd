...
0.81.0 (2013-12-23) Development release
...
it is not a CODE reference, or cannot be found as a relative file name.
...
L<File::Which> if it is not a CODE reference or cannot be found in the
file-system as a relative file name.
...
An array ref containing the command or CODE reference and its
arguments.
